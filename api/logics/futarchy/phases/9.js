        ...
        const phase = {
            ...
            onEnter: async function () {
                ...
                this.game.players.forEach(player => {
                    ...
                    const playerShares = player.wallet[winningCondition].shares;
                    const playerBalance = player.wallet[winningCondition].balance;

                    player.profit.push({
                        "phase": 9,
                        "amount": Math.round(taxPot * playerShares / totalShares + playerBalance - self.game.parameters.owner_balance),
                        "context": {
                            "type": "tax-income",
                            "condition": winningCondition
                        }
                    ...
                    const taxProfit = Math.round(taxPot * playerShares / totalShares + playerBalance - self.game.parameters.owner_balance);
