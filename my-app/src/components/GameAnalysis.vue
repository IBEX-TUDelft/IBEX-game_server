        ...
        methods: {
            ...
            exportXlsxWide() {
                ...
                xls.push([
                    ...
                    'Num_Bids_NP', 'Num_Asks_NP', 'Num_Buys_NP', 'Num_Sells_NP', 'Ending_Cash_NP', 'Ending_Shares_NP', 'realized_value_shares_NP', '',
                    'Num_Bids_P', 'Num_Asks_P', 'Num_Buys_P', 'Num_Sells_P', 'Ending_Cash_P', 'Ending_Shares_P', 'realized_value_shares_P', '',
