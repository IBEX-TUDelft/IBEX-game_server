                    ...
                    <td :style="player.tag === 'Owner 1' ? 'border: 2px yellow solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[0] == null ? '-' : game.declarations[0].d[condition] }} ({{ getSniperProbability(0, condition)}}%)
                            </div>
                        </div>
                    </td>
                    <td :style="player.tag === 'Developer' ? 'border: 2px red solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[1] == null ? '-' : game.declarations[1].d[condition] }} ({{ getSniperProbability(1, condition)}}%)
                            </div>
                        </div>
                    </td>
                    <td :style="player.tag === 'Owner 2' ? 'border: 2px yellow solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[2] == null ? '-' : game.declarations[2].d[condition] }} ({{ getSniperProbability(2, condition)}}%)
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td :style="player.tag === 'Owner 3' ? 'border: 2px yellow solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[3] == null ? '-' : game.declarations[3].d[condition] }} ({{ getSniperProbability(3, condition)}}%)
                            </div>
                        </div>
                    </td>
                    <td :style="player.tag === 'Owner 4' ? 'border: 2px yellow solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[4] == null ? '-' : game.declarations[4].d[condition] }} ({{ getSniperProbability(4, condition)}}%)
                            </div>
                        </div>
                    </td>
                    <td :style="player.tag === 'Owner 5' ? 'border: 2px yellow solid;' : ''">
                        ...
                        <div class="min-vh-50 d-flex align-items-center" style="min-height: 50px;">
                            <div class="container text-center">
                                ...
                                {{ game.declarations[5] == null ? '-' : game.declarations[5].d[condition] }} ({{ getSniperProbability(5, condition)}}%)
                            </div>
                        </div>
                    </td>
                </tr>
